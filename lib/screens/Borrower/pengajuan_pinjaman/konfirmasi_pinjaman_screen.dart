                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          CustomRow(
                              ...
                              rightText:
                                  pengajuanLoanProvider.amount.toString()),
                          CustomRow(
                          ...
                          CustomRow(
                              leftText: "Tenor",
                              rightText:
                                  pengajuanLoanProvider.tenor.toString()),
                          CustomRow(
                          ...
                          CustomRow(
                            leftText: "Nama Bank",
                            rightText: pengajuanLoanProvider.bank.bankCode,
                          ),
                          CustomRow(
                            leftText: "Nomor Rekening",
                            rightText: pengajuanLoanProvider.bank.accountNumber,
                          ),
                        ]),
                  ),
                ),
